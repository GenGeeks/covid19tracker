...
function showLockdownAreas(){
  ...
  .then(data => {     
      ...
      map.on('click', 'lockdown', function(e) {
        ...
        .setLngLat(e.lngLat)
        .setHTML(
          '<strong>' + e.features[0].properties.name + '</strong> <br /> <br /> Total Active Cases: 2 <br /> Lockdown Start Date: ' + e.features[0].properties.Lockdown_Start_Date + ' <br /> Lockdown End Date: ' + e.features[0].properties.Lockdown_End_Date
          )
        .addTo(map);
        });
